...
namespace VentaYServicoMedico.Areas.Admin.Controllers
{
    ...
    public class MenuItemController : Controller
    {
        ...
        {
            var menuItems = await _db.MenuItem.Include(
                m => m.Category).Include(m => m.SubCategory).ToListAsync();
        ...
        public async Task<IActionResult> CreatePOST()
        {
            ...
            if (files.Count > 0)
            {
                ...
                using (var filesStream =
                    new FileStream(Path.Combine(uploads, MenuItemVM.MenuItem.Id + extension),
                    FileMode.Create))
                {
        ...
        public async Task<IActionResult> EditPOST(int? id)
        {
            ...
            //menuItemFromDb.Dietary = MenuItemVM.MenuItem.Dietary;
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            MenuItemVM.MenuItem = await _db.MenuItem.Include(m =>
