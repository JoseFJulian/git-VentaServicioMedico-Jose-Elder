...
namespace VentaYServicoMedico.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //}
                    //if (!await _roleManager.RoleExistsAsync(SD.DoctorUser))
                    //{
                    //    await _roleManager.CreateAsync(new IdentityRole(SD.DoctorUser));
                    //}
                    ...
                    if (role == SD.DoctorUser)
                    {
                        await _userManager.AddToRoleAsync(user, SD.DoctorUser);
                    }
                    else
                    {
